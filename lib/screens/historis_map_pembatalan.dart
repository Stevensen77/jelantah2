...
class Historis_Map_Pembatalan extends StatefulWidget {
  @override
  _Historis_Map_PembatalanState createState() =>
      _Historis_Map_PembatalanState();
}

class _Historis_Map_PembatalanState extends State<Historis_Map_Pembatalan> {
